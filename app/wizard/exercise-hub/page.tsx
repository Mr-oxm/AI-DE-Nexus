...
export default function ExerciseHubWizardPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      const res = await fetch("/api/exercises/hubs", {
        method: "POST",
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 md:px-10">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-bold text-zinc-50">Create Exercise Hub</h1>
        <p className="text-sm text-zinc-500 mt-1">
          Create a new exercise set (e.g. &quot;Python Exercises&quot;). Then add exercises to it.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <input
            ...
            placeholder="e.g. Python Exercises"
        ...
        >
          {loading ? "Creating..." : "Create Exercise Hub"}
        </button>
      </form>
      </div>
    </div>
